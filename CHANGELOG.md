...
* bump actions/setup-node from 3 to 4 ([2652d1c](https://github.com/mattwebbio/orbital-sync/commit/2652d1c4cf8e6899375110fe842e72ff7fb338c4))
* bump docker/login-action from 2 to 3 ([e8dc6e4](https://github.com/mattwebbio/orbital-sync/commit/e8dc6e420e2e00a6e15479b212351cb9a34cceab))
* bump docker/setup-buildx-action from 2 to 3 ([cc09602](https://github.com/mattwebbio/orbital-sync/commit/cc0960242434a41a6cc8892a17c19328db6b3688))
* bump docker/setup-qemu-action from 2 to 3 ([b33359a](https://github.com/mattwebbio/orbital-sync/commit/b33359a056726d24a2146d4926e7531a0eec28af))
* bump github/codeql-action from 2 to 3 ([f57ee01](https://github.com/mattwebbio/orbital-sync/commit/f57ee014876127ba7c0887c5fa8c479a459a709d))
...
- Bump eslint from 8.32.0 to 8.36.0 [`#157`](https://github.com/mattwebbio/orbital-sync/pull/157)
- Bump @typescript-eslint/parser from 5.49.0 to 5.56.0 [`#164`](https://github.com/mattwebbio/orbital-sync/pull/164)
...
- Bump @typescript-eslint/eslint-plugin from 5.48.2 to 5.55.0 [`#161`](https://github.com/mattwebbio/orbital-sync/pull/161)
- Fix upload success expectation [`#163`](https://github.com/mattwebbio/orbital-sync/pull/163)
- Bump eslint-config-prettier from 8.5.0 to 8.6.0 [`#128`](https://github.com/mattwebbio/orbital-sync/pull/128)
- Bump @typescript-eslint/parser from 5.48.1 to 5.49.0 [`#132`](https://github.com/mattwebbio/orbital-sync/pull/132)
- Bump @honeybadger-io/js from 4.8.1 to 4.9.3 [`#130`](https://github.com/mattwebbio/orbital-sync/pull/130)
- Bump jest and @types/jest [`#133`](https://github.com/mattwebbio/orbital-sync/pull/133)
- Bump prettier from 2.8.0 to 2.8.3 [`#126`](https://github.com/mattwebbio/orbital-sync/pull/126)
- Bump @typescript-eslint/eslint-plugin from 5.48.1 to 5.48.2 [`#125`](https://github.com/mattwebbio/orbital-sync/pull/125)
- Update CHANGELOG.md [`971adba`](https://github.com/mattwebbio/orbital-sync/commit/971adba53f1f221b03d983ca54816a55366dae5e)
...
## [1.5.1-0](https://github.com/mattwebbio/orbital-sync/compare/v1.5.0...v1.5.1-0) (2023-01-22)

- Bump nodemailer from 6.8.0 to 6.9.0 [`#122`](https://github.com/mattwebbio/orbital-sync/pull/122)
- Bump nock from 13.2.9 to 13.3.0 [`#121`](https://github.com/mattwebbio/orbital-sync/pull/121)
- Bump @typescript-eslint/eslint-plugin from 5.47.0 to 5.48.1 [`#120`](https://github.com/mattwebbio/orbital-sync/pull/120)
- Bump ts-jest from 29.0.3 to 29.0.5 [`#119`](https://github.com/mattwebbio/orbital-sync/pull/119)
- Bump eslint from 8.31.0 to 8.32.0 [`#118`](https://github.com/mattwebbio/orbital-sync/pull/118)
- Bump @types/jest from 29.2.4 to 29.2.5 [`#112`](https://github.com/mattwebbio/orbital-sync/pull/112)
- Bump @typescript-eslint/parser from 5.48.0 to 5.48.1 [`#117`](https://github.com/mattwebbio/orbital-sync/pull/117)
- Bump @types/nodemailer from 6.4.6 to 6.4.7 [`#113`](https://github.com/mattwebbio/orbital-sync/pull/113)
- Bump @types/luxon from 3.1.0 to 3.2.0 [`#114`](https://github.com/mattwebbio/orbital-sync/pull/114)
- Bump @typescript-eslint/parser from 5.42.0 to 5.48.0 [`#115`](https://github.com/mattwebbio/orbital-sync/pull/115)
- Bump eslint from 8.28.0 to 8.31.0 [`#111`](https://github.com/mattwebbio/orbital-sync/pull/111)
- Bump json5 from 2.2.1 to 2.2.2 [`#109`](https://github.com/mattwebbio/orbital-sync/pull/109)
- Bump @typescript-eslint/eslint-plugin from 5.46.0 to 5.47.0 [`#107`](https://github.com/mattwebbio/orbital-sync/pull/107)
- Bump @honeybadger-io/js from 4.7.4 to 4.8.1 [`#106`](https://github.com/mattwebbio/orbital-sync/pull/106)
- Bump typescript from 4.9.3 to 4.9.4 [`#105`](https://github.com/mattwebbio/orbital-sync/pull/105)
- Bump @types/jest from 29.2.3 to 29.2.4 [`#103`](https://github.com/mattwebbio/orbital-sync/pull/103)
- Bump node-html-parser from 6.1.1 to 6.1.4 [`#95`](https://github.com/mattwebbio/orbital-sync/pull/95)
- Bump @typescript-eslint/eslint-plugin from 5.44.0 to 5.46.0 [`#98`](https://github.com/mattwebbio/orbital-sync/pull/98)
- Bump @honeybadger-io/js from 4.7.1 to 4.7.4 [`#94`](https://github.com/mattwebbio/orbital-sync/pull/94)
- Bump node-fetch from 3.2.10 to 3.3.0 [`#93`](https://github.com/mattwebbio/orbital-sync/pull/93)
- Update CHANGELOG.md [`f8675d4`](https://github.com/mattwebbio/orbital-sync/commit/f8675d41cccbc9de647d5f15c0d3d52ad170149d)
- Trim newlines when checking upload status [`e3d7ea7`](https://github.com/mattwebbio/orbital-sync/commit/e3d7ea737ff821061e2ea3b11b5433f17197914f)
- upgrade Node version to latest 18.x [`40261ee`](https://github.com/mattwebbio/orbital-sync/commit/40261eea69c607b099591ae332f66e3be4a419b0)

## [1.5.0](https://github.com/mattwebbio/orbital-sync/compare/v1.4.1-0...v1.5.0) (2022-11-29)

- Bump @types/luxon from 3.0.1 to 3.1.0 [`#91`](https://github.com/mattwebbio/orbital-sync/pull/91)
...
- Bump prettier from 2.7.1 to 2.8.0 [`#89`](https://github.com/mattwebbio/orbital-sync/pull/89)
- Bump jest and @types/jest [`#88`](https://github.com/mattwebbio/orbital-sync/pull/88)
- Bump @typescript-eslint/eslint-plugin from 5.43.0 to 5.44.0 [`#86`](https://github.com/mattwebbio/orbital-sync/pull/86)
- Update CHANGELOG.md [`04fcd1a`](https://github.com/mattwebbio/orbital-sync/commit/04fcd1a858106b6a9b304776917bbee976db93d4)

## [1.4.1-0](https://github.com/mattwebbio/orbital-sync/compare/v1.4.0...v1.4.1-0) (2022-11-25)
...
- Update CHANGELOG.md [`e01b324`](https://github.com/mattwebbio/orbital-sync/commit/e01b3246beb9e01553f7c6af17631ecf703500c8)
...
## [1.4.0-1](https://github.com/mattwebbio/orbital-sync/compare/v1.4.0-0...v1.4.0-1) (2022-11-01)
...
## [1.4.0-0](https://github.com/mattwebbio/orbital-sync/compare/v1.3.0...v1.4.0-0) (2022-10-31)
...
## [1.2.2-beta.0](https://github.com/mattwebbio/orbital-sync/compare/v1.2.1...v1.2.2-beta.0) (2022-09-30)
...
## [1.1.3-beta.2](https://github.com/mattwebbio/orbital-sync/compare/v1.1.3-beta.1...v1.1.3-beta.2) (2022-09-28)
...
## [1.1.3-beta.1](https://github.com/mattwebbio/orbital-sync/compare/v1.1.3-beta.0...v1.1.3-beta.1) (2022-09-28)
...
## [1.1.3-beta.0](https://github.com/mattwebbio/orbital-sync/compare/v1.1.2...v1.1.3-beta.0) (2022-09-28)
...
## [1.1.2](https://github.com/mattwebbio/orbital-sync/compare/v1.1.1...v1.1.2) (2022-09-12)
...
## [1.1.1](https://github.com/mattwebbio/orbital-sync/compare/v1.1.0...v1.1.1) (2022-09-12)
...
## [1.1.0](https://github.com/mattwebbio/orbital-sync/compare/v1.0.3...v1.1.0) (2022-09-04)
...
## [1.0.3](https://github.com/mattwebbio/orbital-sync/compare/v1.0.2...v1.0.3) (2022-08-30)
...
## [1.0.2](https://github.com/mattwebbio/orbital-sync/compare/v1.0.1...v1.0.2) (2022-08-30)
...
## [1.0.1](https://github.com/mattwebbio/orbital-sync/compare/v1.0.0...v1.0.1) (2022-08-30)
...
## [0.0.8](https://github.com/mattwebbio/orbital-sync/compare/v0.0.7...v0.0.8) (2022-08-25)
...
## [0.0.7](https://github.com/mattwebbio/orbital-sync/compare/v0.0.6...v0.0.7) (2022-08-25)
...
## [0.0.6](https://github.com/mattwebbio/orbital-sync/compare/v0.0.5...v0.0.6) (2022-08-25)
...
## [0.0.5](https://github.com/mattwebbio/orbital-sync/compare/v0.0.4...v0.0.5) (2022-08-25)
...
## [0.0.4](https://github.com/mattwebbio/orbital-sync/compare/v0.0.3...v0.0.4) (2022-08-25)
...
## [0.0.3](https://github.com/mattwebbio/orbital-sync/compare/v0.0.2...v0.0.3) (2022-08-25)
